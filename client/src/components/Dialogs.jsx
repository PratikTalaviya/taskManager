      ...
      <ModalWrapper open={open} setOpen={closeDialog}>
        <div className="py-4 w-full flex flex-col gap-4 items-center justify-center">
          ...
          <div className=" py-3 sm:flex sm:flex-row-reverse gap-4">
            ...
            <Button
              type="button"
              className="bg-gray-200 px-8 text-sm font-semibold rounded-xl text-gray-900 sm:w-auto border"
              onClick={() => closeDialog()}
              label="Cancel"
            />
          </div>
    ...
    <>
      <ModalWrapper open={open} setOpen={closeDialog}>
        <div className="py-4 w-full flex flex-col gap-4 items-center justify-center">
          ...
          <p className="text-center text-gray-500">{"Are you sure you want to activate or deactive this account?"}</p>

          <div className="py-3 sm:flex sm:flex-row-reverse gap-4">
            <Button
              type="button"
              className={clsx(
                "rounded-xl px-8 text-sm font-semibold text-white sm:w-auto",
